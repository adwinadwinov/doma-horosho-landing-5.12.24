<header class="header js-header">
    <div class="header__left">
        ...
        <a class="logo header__logo" href="#">
            <img class="logo__img header__img" src="/assets/images/logo.svg" alt="Домо хорошо" />
        </a>
    </div>
    <nav class="nav">
        <ul class="nav__list">
            <li class="nav__item">
                <a href="#catalog" class="nav__link" data-catalog="kitchens">Кухни</a>
            </li>
            <li class="nav__item">
                <a href="#catalog" class="nav__link" data-catalog="wardrobes">Шкафы</a>
            </li>
            <li class="nav__item">
                <a href="#promotions" class="nav__link">Акции</a>
            </li>
            <li class="nav__item">
    ...
    <div class="header__contacts">
        <a class="link" href="tel:+78122505994">
        ...
        <a href="https://wa.me/78122505994" class="button" role="button" target="_blank">Связаться в WhatsApp</a>
    </div>
    <div class="mobile-contacts">
        <a class="mobile-contacts__ws" href="https://wa.me/78122505994">
            <img class="mobile-contacts__img" src="/assets/images/ws.svg" alt="WhatsApp" />
        </a>
        <a class="mobile-contacts__phone" href="tel:78122505994">
            <img class="mobile-contacts__img" src="/assets/images/phone.svg" alt="Трубка" />
        </a>
    </div>
</header>