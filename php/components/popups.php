...
<div class="popups-container">
    <div class="popup calc-popup" data-popup="popup-calc">
        ...
        <div class="popup-header">
            <h2 class="popup__title js-popup__title">Запросить расчет</h2>
        </div>
        <div class="popup-body">
            <form class="popup__form js-form" data-status="idle">
                ...
                <div class="calc-popup__cbs js-calc-popup__cbs">
                    <p class="popup__sub-title">Где с вами связаться?</p>
                    <div class="callback-kind js-callback-kind">
                        <button class="callback-kind__btn callback-kind__btn--active js-callback-kind__btn" role="checkbox" data-callback-type="WhatsApp">
                        ...
                        <button class="callback-kind__btn js-callback-kind__btn" role="checkbox" data-callback-type="Звонок">
                            <svg
                ...
                <button class="button button--full popup__button js-submit-button" type="submit">Отправить заявку</button>
            </form>
        </div>
        <div class="popup-footer">
            <p class="popup-footer__sub">Нажимая кнопку "Оставить заявку", вы соглашаетесь с Политикой конфиденциальности</p>
        </div>
    </div>
    <div class="popup success-popup" data-popup="success-popup">
        <button class="close-btn popup__close"></button>
        <div class="popup-header">
        ...
        <div class="popup-footer">
            <button class="button button--full popup__button success-popup__button close-btn">Ок, понятно</button>
        </div>
    </div>
    <div class="popup success-popup" data-popup="error-popup">
        <button class="close-btn popup__close"></button>
        <div class="popup-header">
            <h2 class="popup__title">Ошибка! Не удалось отправить заявку</h2>
        </div>
        <div class="popup-body">
            <div class="popup__text">Что-то пошло не так. Пожалуйста, попробуйите позже</div>
        </div>
        <div class="popup-footer">
            <button class="button button--full popup__button close-btn">Ок, понятно</button>
        </div>
    </div>
</div>
