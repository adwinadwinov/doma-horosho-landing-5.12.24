        ...
        <div class="popup-body">
            <form class="calc-popup__form">
                <div class="calc-popup__inputs">
                    <input class="calc-popup__input" placeholder="Ваше имя" type="text" />
                    <input class="calc-popup__input" placeholder="Контактный телефон" type="text" />
                </div>
...
<div style="width: 100%; display: none; padding: 0; border-radius: 20px; background-color: transparent" id="video-popup">
    <video controls autoplay muted style="width: auto; max-height: 400px; padding: 0">
