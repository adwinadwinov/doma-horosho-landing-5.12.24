<div class="mobile-menu js-mobile-menu" id="mobile-nav-menu">
    <div class="mobile-menu__backplate js-mobile-menu__backplate"></div>
    <div class="mobile-menu__inner">
        ...
        <div class="divider mobile-menu__divider"></div>
        <div class="header__contacts mobile-menu__contacts">
            <a class="link mobile-menu__link" href="<?= $CONTACTS['header_phone']['link']; ?>">
            ...
            <a class="button" data-trigger="popup-calc" data-popup-title="Мы свяжемся с вами в WhatsApp" data-ws>Связаться в WhatsApp</a>
        </div>
    </div>
</div>